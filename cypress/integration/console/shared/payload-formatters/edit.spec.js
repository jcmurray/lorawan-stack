...
describe('Payload formatters', () => {
  ...
  describe('Application', () => {
    ...
    describe('Uplink', () => {
      ...
      it('successfully changes formatter type to Javascript', () => {
        cy.visit(
          `${Cypress.config(
            'consoleRootPath',
        ...
        cy.findByTestId('code-editor').should('exist')
      ...
      it('successfully changes formatter type to GRPC service', () => {
        cy.visit(
          `${Cypress.config(
            'consoleRootPath',
          )}/applications/${applicationId}/payload-formatters/uplink`,
      ...
      it('successfully changes formatter type to CayenneLPP', () => {
        cy.visit(
          `${Cypress.config(
            'consoleRootPath',
          )}/applications/${applicationId}/payload-formatters/uplink`,
      ...
      it('successfully changes formatter type to Repository', () => {
        cy.visit(
          `${Cypress.config(
            'consoleRootPath',
          )}/applications/${applicationId}/payload-formatters/uplink`,
      ...
      it('successfully changes formatter type to None', () => {
        cy.visit(
          `${Cypress.config(
            'consoleRootPath',
          )}/applications/${applicationId}/payload-formatters/uplink`,
  ...
  describe('End Devices', () => {
    const applicationId = 'app-enddevice-payload-formatter-test'
    const application = {
    ...
    describe('Uplink', () => {
      ...
      it('successfully changes formatter type to Application payload formatter', () => {
        cy.visit(
          `${Cypress.config(
            'consoleRootPath',
          )}/applications/${applicationId}/devices/${endDeviceId}/payload-formatters/uplink`,
